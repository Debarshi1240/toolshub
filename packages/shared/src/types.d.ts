...
export type JobType = 'merge-pdf' | 'split-pdf' | 'compress-pdf' | 'pdf-to-word' | 'word-to-pdf' | 'pdf-to-jpg' | 'jpg-to-pdf' | 'rotate-pdf' | 'watermark-pdf' | 'protect-pdf' | 'unlock-pdf' | 'reorder-pdf' | 'create-zip' | 'compress-all' | 'download' | 'plagiarism';
